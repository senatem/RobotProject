...
namespace RobotProject
{
    ...
    public class OffsetCalculator
    {
        ...
        {
            return new Offsets(0 + ((palletWidth * 10) % 200) / 2, 0, pz * counter + palletHeight, 1, counter);
        }
        ...
        private static Offsets PatternTwo(int px, int pz, int counter, int palletHeight, int palletWidth)
        {
            ...
            {
                0 => new Offsets(-px + ((palletWidth * 10) % 200) / 2, 0, pz * ((counter + 1) / 2) + palletHeight, 2, (counter + 1) / 2),
                1 => new Offsets(0 + ((palletWidth * 10) % 200) / 2, 0, pz * ((counter + 1) / 2) + palletHeight, 2, (counter + 1) / 2),
                _ => throw new ArgumentOutOfRangeException()
            };
        }
        ...
        private static Offsets PatternThree(int px, int pz, int counter, int palletHeight, int palletWidth)
        {
            ...
            {
                0 => new Offsets(-2*px + ((palletWidth * 10) % 200) / 2, 0, pz * ((counter + 2) / 3) + palletHeight, 3, (counter + 2) / 3),
                1 => new Offsets(0 + ((palletWidth * 10) % 200) / 2, 0, pz * ((counter + 2) / 3) + palletHeight, 3, (counter + 2) / 3),
                2 => new Offsets(-px + ((palletWidth * 10) % 200) / 2, 0, pz * ((counter + 2) / 3) + palletHeight, 3, (counter + 2) / 3),
                _ => throw new ArgumentOutOfRangeException()
            };
        }
        ...
        private static Offsets PatternFour(int px, int py, int pz, int counter, int palletHeight, int palletWidth)
        {
            ...
            {
                0 => new Offsets(-px + ((palletWidth * 10) % 200) / 2, -py, pz * ((counter + 3) / 4) + palletHeight, 4, (counter + 3) / 4),
                1 => new Offsets(0 + ((palletWidth * 10) % 200) / 2, py, pz * ((counter + 3) / 4) + palletHeight, 4, (counter + 3) / 4),
                2 => new Offsets(0 + ((palletWidth * 10) % 200) / 2, -py, pz * ((counter + 3) / 4) + palletHeight, 4, (counter + 3) / 4),
                3 => new Offsets(-px + ((palletWidth * 10) % 200) / 2, py, pz * ((counter + 3) / 4) + palletHeight, 4, (counter + 3) / 4),
                _ => throw new ArgumentOutOfRangeException()
            };
        }
        ...
        private static Offsets PatternFive(int py, int pz, int counter, int palletHeight, int palletWidth)
        {
            return (counter % 2) switch
            {
                0 => new Offsets(0 + ((palletWidth * 10) % 200) / 2, py/2, pz * ((counter + 1) / 2) + palletHeight, 2, (counter + 1) / 2),
                1 => new Offsets(0 + ((palletWidth * 10) % 200) / 2, py/2, pz * ((counter + 1) / 2) + palletHeight, 2, (counter + 1) / 2),
                _ => throw new ArgumentOutOfRangeException()
            };
        }
    }
